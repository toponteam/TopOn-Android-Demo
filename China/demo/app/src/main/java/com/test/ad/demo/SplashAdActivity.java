...
//    private Spinner mSpinnerPlacementId;
    ...
    private void loadAd() {
        ...
        if (mSplashAd != null) {
            ...
            mSplashAd.setNativeAdCustomRender(new ATNativeAdCustomRender() {
                @Override
                public View getMediationViewFromNativeAd(ATNativeAdInfo mixNativeAd, ATAdInfo atAdInfo) {
                    return MediationNativeAdUtil.getViewFromNativeAd(SplashAdActivity.this, mixNativeAd, atAdInfo, false);
                }
            });
            mSplashAd.loadAd();
        }
